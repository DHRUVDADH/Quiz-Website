      ...
      <div className={`flex-center ${s.cont1}`}>
        ...
        <div className={s.item}>
            ...
            <div><img src='./Assets/mail.svg' ></img>
              <input type="fname" id='fname' className={s.input} placeholder='Type your first name' /></div>
          </div>
          <div className={s.item}>
            <label htmlFor="lname">Your last name</label>
            <div><img src='./Assets/mail.svg' ></img>
              <input type="lname" id='lname' className={s.input} placeholder='Type your last name' /></div>
          </div>
          <div className={s.item}>
